...
MAKECMD         = /home/srivatsan/apps/matlab/bin/glnxa64/gmake -j 6 -l 10
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = sliding_mode
MODULES                 = rtGetInf.c rt_nonfinite.c sliding_mode.c sliding_mode_capi.c sliding_mode_data.c sliding_mode_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = sliding_mode
MAKEFILE                = sliding_mode.mk
MATLAB_ROOT             = /home/srivatsan/apps/matlab
ALT_MATLAB_ROOT         = /home/srivatsan/apps/matlab
START_DIR               = /home/srivatsan/dev/pravahan
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 4
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/home/srivatsan/apps/matlab" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DUSE_LOCALHOST -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/home/srivatsan/apps/matlab/sys/os/glnxa64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/sliding_mode \
